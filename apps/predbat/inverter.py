...
from huawei import HuaweiHelper
...
class Inverter:
    ...
    def __init__(self, base, id=0, quiet=False, rest_postCommand=None, rest_getData=None):
        ...
        # Experimental Huawei LUNA2000 helper
        self.huawei = None

        if self.inverter_type == "HU":
            self.huawei = HuaweiHelper(self)
            self.log("Huawei TEST: HuaweiHelper loaded")
            self.huawei.log_tou_periods()
